...
const VideoLibraryPage = ({ user }) => {
  ...
  const handleVideoClick = async (video) => {
    ...
    setModalInstanceId(Math.random().toString(36).substring(7));
  ...
  useEffect(() => {
    ...
    const initPlayer = () => {
      if (window.YT && window.YT.Player) {
        const newPlayer = new window.YT.Player(`youtube-player-${selectedVideo.id}-${modalInstanceId}`, {
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl max-w-6xl w-full max-h-[95vh] overflow-y-auto">
            ...
            <div className="aspect-video bg-black relative">
              <style>{`
                ...
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-chrome-bottom,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-chrome-top,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-chrome-controls,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-progress-bar-container,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-time-display,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-left-controls,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-right-controls {
                ...
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-youtube-button,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-watermark,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-chrome-top-buttons,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-show-cards-title,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-title,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-title-text,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-title-channel,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-title-link,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .branding-img,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-watermark img {
                  display: none !important;
                  opacity: 0 !important;
                  visibility: hidden !important;
                  width: 0 !important;
                ...
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-button[aria-label*="Share"],
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-button[aria-label*="Paylaş"],
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-share-button,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-cards-button,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-watch-later-button,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-size-button,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-overflow-button {
                  display: none !important;
                  opacity: 0 !important;
                  visibility: hidden !important;
                }
                ...
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .annotation,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-pause-overlay,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-ce-element,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-cards-teaser,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-endscreen-content,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-ce-covering-overlay,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-ce-expanding-overlay {
                  display: none !important;
                  opacity: 0 !important;
                  visibility: hidden !important;
                }
                ...
                #youtube-player-${selectedVideo.id}-${modalInstanceId} a[class*="ytp"],
                #youtube-player-${selectedVideo.id}-${modalInstanceId} button[class*="ytp"]:not(.ytp-large-play-button),
                #youtube-player-${selectedVideo.id}-${modalInstanceId} a[href*="youtube.com"],
                #youtube-player-${selectedVideo.id}-${modalInstanceId} [class*="ytp-button"] {
                  display: none !important;
                  opacity: 0 !important;
                ...
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-gradient-top,
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .ytp-gradient-bottom {
                  display: none !important;
                  opacity: 0 !important;
                }
                
                /* IFrame pointer events - sadece videoya izin ver */
                #youtube-player-${selectedVideo.id}-${modalInstanceId} iframe {
                  pointer-events: none !important;
                }
                
                #youtube-player-${selectedVideo.id}-${modalInstanceId} .html5-video-player {
                  pointer-events: auto !important;
                  cursor: pointer !important;
                }
                
                /* Video frame'i temiz tut */
                #youtube-player-${selectedVideo.id}-${modalInstanceId} {
                  position: relative;
                  overflow: hidden;
                }
              `}</style>
              
              <div id={`youtube-player-${selectedVideo.id}-${modalInstanceId}`} className="w-full h-full"></div>
