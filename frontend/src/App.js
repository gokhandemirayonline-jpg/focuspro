...
import { authAPI, userAPI, videoAPI, progressAPI, meetingAPI, taskAPI, goalAPI, reasonAPI, prospectAPI, partnerAPI, habitAPI, eventAPI, eventRegistrationAPI, notificationAPI, recommendationAPI, blogAPI, searchAPI, fileAPI } from './services/api';
...
const FocusProApp = () => {
  ...
  return (
    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'w-64' : 'w-0 md:w-20'} ${darkMode ? 'bg-[#2a2a2a]' : 'bg-gradient-to-b from-purple-700 to-indigo-800'} text-white transition-all duration-300 flex flex-col fixed md:relative h-full z-50 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
      ...
      {/* Main Content */}
      <div className={`flex-1 overflow-auto flex flex-col w-full ${sidebarOpen ? 'md:ml-0' : 'md:ml-20'} transition-all duration-300`}>
