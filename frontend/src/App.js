                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                  <div className="bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[95vh] overflow-y-auto">
                    ...
                    <div className="relative aspect-video bg-black">
                      ...
                      <div className="absolute top-4 right-4 bg-black/80 backdrop-blur-sm rounded-lg px-4 py-2 shadow-lg z-10">
                        <div className="flex items-center gap-3">
                          <div className="text-white text-xs">
                            <div className="text-gray-300 mb-1">İzleme İlerlemesi</div>
                            <div className="flex items-center gap-2">
                              ...
                              <span id={`video-percentage-${selectedVideo.id}`} className="font-bold text-sm text-purple-300">%0</span>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="mt-6">
                ...
                {agendaTab === 'habits' && (
                  <div>
                    {/* HABITS CONTENT */}
                    <div className="mb-6 flex items-center justify-between">
                      <h2 className="text-2xl font-bold text-gray-800">✅ Günlük Alışkanlıklar</h2>
                      <button
                        onClick={() => {
                    ...
                    <div className="space-y-4">
                        ...
                        <div key={habit.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                          <div className="flex items-center justify-between mb-4">
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-gray-500 mt-1">Hedef: {habit.target} kez</p>
                            </div>
                            <div className="flex gap-2">
                              <button
                                onClick={() => {
                                  setEditingHabit(habit);
                                  setNewHabit({ title: habit.title, target: habit.target });
                                  setShowHabitModal(true);
                                }}
                          ...
                          <div className="flex items-center gap-4">
                              ...
                              <div className="flex-1 bg-gray-200 rounded-full h-3">
                                <div
                                  className={`h-3 rounded-full transition-all ${
                                    habit.done ? 'bg-green-600' : 'bg-purple-600'
                                  }`}
                            ...
                            <div className="flex gap-2">
                              <button
                                onClick={() => updateHabitProgress(habit.id, Math.max(habit.completed - 1, 0))}
                                className="bg-gray-200 hover:bg-gray-300 text-gray-700 w-10 h-10 rounded-lg flex items-center justify-center font-bold"
                                disabled={habit.completed === 0}
                              >
                                -
                              </button>
                              <button
                                onClick={() => updateHabitProgress(habit.id, habit.completed + 1)}
                                className="bg-purple-600 hover:bg-purple-700 text-white w-10 h-10 rounded-lg flex items-center justify-center font-bold"
                      ...
                      {dailyHabits.length === 0 && (
                        <div className="text-center py-12 bg-gray-50 rounded-xl">
                          <CheckCircle2 size={48} className="mx-auto text-gray-400 mb-3" />
                          <p className="text-gray-600">Henüz alışkanlık eklenmemiş</p>
                          <p className="text-gray-500 text-sm mt-1">Yeni alışkanlık eklemek için yukarıdaki butona tıklayın</p>
                        </div>
                      )}
                    </div>
                  </div>
